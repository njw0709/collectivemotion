...
%directory = cd;   %uigetdir; %directory containing the images you want to analyze
...
clearvars -except filepath filebase_image filebase_aviresults filebase_results csvname name p s x y u v typevector directory filenames u_filt v_filt typevector_filt
disp('CMND LN DONE.')